...
public final class ActivityResultsBinding implements ViewBinding {
  ...
  private ActivityResultsBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView logRecycler, @NonNull TextView textView, @NonNull TextView textView2,
      @NonNull TextView textView3) {
    this.rootView = rootView;
    this.logRecycler = logRecycler;
  ...
  public static ActivityResultsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.logRecycler;
      RecyclerView logRecycler = rootView.findViewById(id);
      if (logRecycler == null) {
        break missingId;
      }
      ...
      return new ActivityResultsBinding((ConstraintLayout) rootView, logRecycler, textView,
          textView2, textView3);
    }
